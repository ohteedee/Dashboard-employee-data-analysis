...
CREATE TABLE public.categories (
    ...
    descriptioncol character varying,
    picture text
);
...
CREATE TABLE public.suppliers (
    ...
    contacttitle character varying(200),
    addresses character varying(300),
    city character varying(50),
...
COPY public.categories (categoryid, categoryname, descriptioncol, picture) FROM stdin;
...
COPY public.customers (customerid, companyname, contactname, contacttitle, addresses, city, region, postalcode, country, phone, fax) FROM stdin;
...
COPY public.employees (employeeid, lastname, firstname, title, titleofcourtesy, birthdate, hiredate, addresses, city, region, postalcode, country, homephone, extension, photo, notes, reportsto, photopath) FROM stdin;
...
COPY public.suppliers (supplierid, companyname, contactname, contacttitle, addresses, city, region, postalcode, country, phone, fax, homepage) FROM stdin;
