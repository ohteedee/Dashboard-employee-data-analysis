...
CREATE TABLE order_details (orderID integer, productID integer, unitPrice float(6), quantity integer, discount float(5));
COPY order_details
...
CREATE TABLE territories (territoryID integer, territoryDescription varchar(50), regionID integer);
COPY territories
